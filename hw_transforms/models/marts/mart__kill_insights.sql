select
    ...
    {{ cast_timestamp("a.off_herd_date") }} as sale_date,
    {{ cast_timestamp("a.moved_in_date") }} as purchase_date,
    ...
    kipc.live_weight as live_weight,
    kipc.derived_live_wt as derived_live_wt,
    kipc.dead_weight as dead_weight,
