...
select distinct
    ...
    wt.record_adg,
    wt.first_weight,
    {{ cast_timestamp("wt.first_weight_date") }} as first_weight_date,
    wt.last_weight,
    wt.prev_weight,
    {{ cast_timestamp("wt.prev_weight_date") }} as prev_weight_date,
    ...
    wt.lifetime_weight_gain,
    wt.in_herd_adg,
    wt.in_herd_weight_gain,
    wt.prev_adg,
