...
# dbt run-operation generate_source --args '{"schema_name": "hw_replicate","database_name": "awsdatacatalog", "generate_columns": true, "include_descriptions": true, "include_data_types": true, "exclude": "%_underlying_%","exclude": "beta_%" , "name": "rds_prod", "include_database": true, "include_schema": true}'|sed 1,5d > codegen/prod_sources_codegen.yml
