dbt run-operation generate_source --args '{"schema_name": "beta_raw","database_name": "awsdatacatalog", "generate_columns": true, "include_descriptions": true, "include_data_types": true, "table_pattern": "beta__%", "exclude": "%_underlying_%" , "name": "rds_beta", "include_database": true, "include_schema": true}'|sed 1,5d > codegen/beta_sources_codegen.yml
dbt run-operation generate_source --args '{"schema_name": "prod_raw","database_name": "awsdatacatalog", "generate_columns": true, "include_descriptions": true, "include_data_types": true, "table_pattern": "rds__%", "exclude": "%_underlying_%" , "name": "rds_prod", "include_database": true, "include_schema": true}'|sed 1,5d > codegen/prod_sources_codegen.yml
